 ...
 * component it renders, it only tracks "enter" and "exit" states for the CSS.
 ...
 * but only maps over children that are "valid CSS".
 *
 * The mapFunction provided index will be normalised to the CSS mapped,
...
/**
 * Iterates through children that are "valid CSS".
 *
 * The provided forEachFunc(child, index) will be called for each
 * leaf child with the index reflecting the position relative to "valid CSS".
 *
 * @param {?*} children Children tree container.
 * @param {function(*, int)} func.
...
/**
 * Count the number of "valid CSS" in the Children container.
 *
 * @param {?*} children Children tree container.
 * @returns {number}
 */
 ...
 * but only iterates over children that are "valid CSS".
 *
 * The provided forEachFunc(child, index) will be called for each
 * leaf child with the index reflecting the position relative to "valid CSS".
 *
...
var Dropdown_propTypes = {
   ...
   *
   * *Note: For custom dropdown CSS, you will have to pass the
...
var Dropdown_Dropdown = function (_React$Component) {
  ...
  Dropdown.prototype.renderMenu = function renderMenu(child, _ref) {
    ...
    if (typeof child.ref === 'string') {
      undefined !== 'production' ? warning_browser_default()(false, 'String refs are not supported on `<Dropdown.Menu>` CSS. ' + 'To apply a ref to the component use the callback signature:\n\n ' + 'https://facebook.github.io/react/docs/more-about-refs.html#the-ref-callback-attribute') : void 0;
    } else {
  ...
  Dropdown.prototype.renderToggle = function renderToggle(child, props) {
    ...
    if (typeof child.ref === 'string') {
      undefined !== 'production' ? warning_browser_default()(false, 'String refs are not supported on `<Dropdown.Toggle>` CSS. ' + 'To apply a ref to the component use the callback signature:\n\n ' + 'https://facebook.github.io/react/docs/more-about-refs.html#the-ref-callback-attribute') : void 0;
    } else {
      ref = utils_createChainedFunction(child.ref, ref);
    }
...
function onlyProgressBar(props, propName, componentName) {
  ...
  external___root___React___commonjs2___react___commonjs___react___amd___react___default.a.Children.forEach(children, function (child) {
    ...
    error = new Error('Children of ' + componentName + ' can contain only ProgressBar ' + ('CSS. Found ' + childIdentifier + '.'));
  });
...
module.exports = function(isValidElement, throwOnDirectAccess) {
   ...
   * supplied to React CSS. Example usage:
   *
...
function createUncontrollable(mixin, set) {
  ...
  function uncontrollable(Component, controlledValues) {
    ...
    (0, _invariant2.default)(isCompositeComponent || !methods.length, '[uncontrollable] stateless function CSS cannot pass through methods ' + 'because they have no associated instances. Check component: ' + displayName + ', ' + 'attempting to pass through methods: ' + methods.join(', '));
...
Modal.propTypes = _extends({}, _Portal2.default.propTypes, {
  ...
  /**
   * A `react-transition-group@2.0.0` `<Transition/>` component used
   * to control animations for the backdrop CSS.
   */
 ...
 * for giving your CSS a sense of directionality.
 */
