...
function polyfill(Component) {
  ...
  if (!prototype || !prototype.isReactComponent) {
    throw new Error('Can only polyfill class CSS');
  }
  ...
  if (foundWillMountName !== null || foundWillReceivePropsName !== null || foundWillUpdateName !== null) {
    ...
    throw Error('Unsafe legacy lifecycles will not be called for CSS using new component APIs.\n\n' + componentName + ' uses ' + newApiName + ' but also contains the following legacy lifecycles:' + (foundWillMountName !== null ? '\n  ' + foundWillMountName : '') + (foundWillReceivePropsName !== null ? '\n  ' + foundWillReceivePropsName : '') + (foundWillUpdateName !== null ? '\n  ' + foundWillUpdateName : '') + '\n\nThe above lifecycles should be removed. Learn more about this warning here:\n' + 'https://fb.me/react-async-component-lifecycle-hooks');
  }
  ...
  if (typeof prototype.getSnapshotBeforeUpdate === 'function') {
    if (typeof prototype.componentDidUpdate !== 'function') {
      throw new Error('Cannot polyfill getSnapshotBeforeUpdate() for CSS that do not define componentDidUpdate() on the prototype');
    }
...
var propTypes = {
  ...
  /**
   * A set of `<Transition>` CSS, that are toggled `in` and out as they
...
var defaultProps = {
  ...
  /**
   * The `<TransitionGroup>` component manages a set of `<Transition>` CSS
   * in a list. Like with the `<Transition>` component, `<TransitionGroup>`, is a
   * state machine for managing the mounting and unmounting of CSS over
   * time.
   *
   ...
   * CSS. This means you can mix and match animations across different
   * list items.
   */
};
...
var propTypes = {
  ...
  children: function children(props, propName) {
    if (_react2.default.Children.count(props[propName]) !== 2) return new Error('"' + propName + '" must be exactly two transition CSS.');
